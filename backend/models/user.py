...
from sqlalchemy import ( # type: ignore
    Column, Integer, String, Boolean, ForeignKey, DateTime, TIMESTAMP, text
)
...
class User(Base):
    ...
    cinema_id     = Column(Integer, ForeignKey("cinemas.cinema_id", ondelete="RESTRICT"), nullable=False)
