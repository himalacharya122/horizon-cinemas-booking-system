...
class TestUserModel:
    def test_full_name(self):
        """TC-MOD-03"""
        user = User(first_name="Himal", last_name="Acharya")
        assert user.full_name == "Himal Acharya"
    ...
    def test_capacity_range(self):
        ...
        for valid in [50, 80, 120]:
            s = Screen(
                ...
                screen_number=1,
                total_seats=valid,
                lower_hall_seats=int(valid * 0.3),
                upper_gallery_seats=valid - int(valid * 0.3),
                vip_seats=0,
            )
